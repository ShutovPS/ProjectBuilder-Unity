    ...
    public class BuildTargetSettings_iOS : IBuildTargetSettings
    {
        ...
        public void DrawSetting(SerializedObject serializedObject)
        {
            ...
            using (new EditorGUIEx.GroupScope("iOS Settings"))
            {
                ...
                {
                    EditorGUIEx.TextFieldWithTemplate(settings.FindPropertyRelative("languages"), s_AvailableLanguages,
                        true);
                    EditorGUIEx.TextFieldWithTemplate(settings.FindPropertyRelative("frameworks"),
                        s_AvailableFrameworks, true);
                    EditorGUIEx.TextFieldWithTemplate(settings.FindPropertyRelative("services"), s_AvailableServices,
                        true);
