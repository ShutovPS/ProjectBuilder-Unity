...
#region KEYSTORE
		...
		[Tooltip("Keystore file path.")] [SerializeField]
		private string keystoreFile = "";

		/// <summary>Keystore password.</summary>
		[Tooltip("Keystore password.")] [SerializeField]
		private string keystorePassword = "";

		/// <summary>Keystore alias name.</summary>
		[Tooltip("Keystore alias name.")] [SerializeField]
		private string keystoreAliasName = "";

		/// <summary>Keystore alias password.</summary>
		[Tooltip("Keystore alias password.")] [SerializeField]
