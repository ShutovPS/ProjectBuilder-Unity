...
namespace Mobcast.Coffee.Build
{
	...
	internal class Util : ScriptableSingleton<Util>
	{
		...
		[SerializeField] protected ProjectBuilder m_CurrentBuilder;

		/// <summary>On finished compile callback.</summary>
		[SerializeField] protected bool m_BuildAndRun = false;

		[SerializeField] protected bool m_BuildAssetBundle = false;
...
#region PLATFORMS
		...
		public static void SwitchActiveBuildTarget(ProjectBuilder projectBuilder)
		{
			var target = projectBuilder.buildTarget;
