...
namespace Mobcast.Coffee.Build.Editor
{
    internal static class EditorGUIExtensions
    {
        ...
        public static void FilePathField(SerializedProperty property, GUIContent label, string title, string directory,
        ...
        public static void TextFieldWithTemplate(SerializedProperty property, GUIContent label,
